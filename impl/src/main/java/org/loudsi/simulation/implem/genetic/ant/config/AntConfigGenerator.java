...
public class AntConfigGenerator implements IGeneticConfigurationGenerator<AntEngineGeneticConfig> {

    public AntEngineGeneticConfig generate(int interval) {
        ...
        return new AntEngineGeneticConfig(
    ...
    public AntEngineGeneticConfig mutateFrom(AntEngineGeneticConfig previousConfig, double variationAmount) {
        HashMap<AntAction, BehaviorConfig> behaviorConfigHashMap = new HashMap<>();
