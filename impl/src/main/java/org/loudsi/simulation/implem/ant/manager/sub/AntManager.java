...
import org.loudsi.simulation.implem.ant.config.BehaviorConfig;
...
public class AntManager {
    ...
    public static void makeAntDecideDirection(Ant ant, AntColony colony, AntEngineConfig antEngineConfig) {
    ...
    public static void antInteract(Ant ant, AntColony colony, AntContext world, AntEngineConfig engineConfig) {
    ...
    public static void produceAnt(AntColony colony, AntEngineConfig config) {
